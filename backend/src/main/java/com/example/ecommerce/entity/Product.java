...
public class Product {
    ...
    private final LocalDateTime createdAt = LocalDateTime.now(); // This field will be excluded from equality and
                                                                 // hashCode
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || getClass() != o.getClass())
            return false; // Using instanceof to allow comparison with subclasses
